            ...
            <>
              ...
              <div className="flex-1 flex flex-col gap-4 overflow-hidden">
                <div 
                  ...
                  style={{ background: 'linear-gradient(to bottom, #383838, #0D0D0D)' }}
                >
